...
class AchievementHelper {
    ...
    public static function setNotification($achievementID, $courseID, $reachedAchievementID)
    {
        ...
        $notification->extra_info = "<a class='btn btn-primary btn-sm' href='" . route('share_achievement_path', [$courseID, $achievement->id]) . "'>Compartir en TICademia</a> <a class='btn btn-info btn-sm' onClick='MyWindow=window.open('https://www.facebook.com/sharer/sharer.php?u=" . route('share_path', [$courseID, $reachedAchievementID]) . "','MyWindow',width=600,height=300); return false;' href='#'> Compartir en Facebook </a>";
