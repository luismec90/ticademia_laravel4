                    ...
                    <div class="panel-body">
                        <div class="tab-content">
                            <div class="tab-pane fade in active">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h4>Vincular cuenta con redes sociales </h4><a  tabindex="0" class="popover_over" data-toggle="popover" data-title="Ayuda" data-placement="top" data-trigger="hover" data-content="Vincular la cuenta con las redes sociales te permitira iniciar sesión con las mismas."><i class="fa fa-question-circle"></i></a>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        @if($linkedWithFacebook)
                                            <a class="btn btn-block btn-social btn-facebook"
                                               href="{{ route('unlink_facebook_path') }}">
                                                <i class="fa fa-facebook"></i> Desvincular de Facebook
                                            </a>
                                        @else
                                            <a class="btn btn-block btn-social btn-facebook"
                                               href="{{ route('link_facebook_path') }}">
                                                <i class="fa fa-facebook"></i> Vincular con Facebook
                                            </a>
                                        @endif
                                    </div>
                                    <div class="col-sm-6">
                                        @if($linkedWithGoogle)
                                            <a class="btn btn-block btn-social btn-google-plus"
                                               href="{{ route('unlink_google_path') }}">
                                                <i class="fa fa-google-plus"></i> Desvincular de Google
                                            </a>
                                        @else
                                            <a class="btn btn-block btn-social btn-google-plus"
                                               href="{{ route('link_google_path') }}">
                                                <i class="fa fa-google-plus"></i> Vincular con Google
                                            </a>
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <center>@include('layouts.partials.avatar_square',['user'=>Auth::user(),'size'=>200])
                                                <br>
                                                <a class="btn btn-primary" id="btn-modal-change-avatar">Cambiar
                                                    imagen</a>
                                            </center>
                                        </div>
                                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div id="container-crop">
                        <div class="bootstrap-modal-cropper">
                            <img id="preview-img-avatar" name="avatar" width="400"
