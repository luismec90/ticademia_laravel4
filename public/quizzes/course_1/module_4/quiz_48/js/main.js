...
function draw() {
    ...
    var answers = ['<span class="fraccion"><span>' + (f1) + '</span><span>(2<sup>' + n + '-m</sup>)(3<sup>k-1</sup>)</span></span>',
        ...
        '<span class="fraccion"><span>' + (f1) + '</span><span>(2<sup>' + n + '-m</sup>)(3<sup>k</sup>)</span></span>',
        '<span class="fraccion"><span>' + (-f1) + '<sup>' + n + '</sup>3<sup> k + 1 </sup>(m+1)<sup>2</sup></span><span>2<sup>'+ n +'+m</sup></span></span>',
        '<span class="fraccion"><span>' + (-f1) + '<sup>' + (n+1) + '</sup>2<sup> '+ n +' + m </sup>(m+1)<sup>2</sup></span><span>3<sup> k + 1 </sup>(m+1)<sup>2</sup></span></span>',
